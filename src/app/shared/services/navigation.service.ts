...
export class NavigationService {
  ...
  iconMenu: IMenuItem[] = [
    ...
    //   type: "link",
    //   tooltip: "Dashboard (Tablet)",
    //   icon: "tablet",
    //   state: "dashboard/analytics-tablet"
    // },
    // {
    //   name: "Dashboard (Mobile)",
    //   type: "link",
    //   tooltip: "Dashboard (Mobile)",
    //   icon: "smartphone",
    //   state: "dashboard/analytics-mobile"
    // },
    // {
    //   name: "lumin-sdk-angular (documentation)",
    //   type: "link",
    //   tooltip: "lumin-sdk-angular (documentation)",
    //   icon: "smartphone",
    //   state: "dashboard/lumin-sdk"
    // },
    // {
    //   name: "PAGES",
    //   type: "separator"
